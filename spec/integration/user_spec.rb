...
RSpec.describe 'User', type: :system do
  ...
  describe 'index page' do
    ...
    before(:each) do 
        @user = User.create(name: 'said', photo: "https://media.tenor.com/TQ3Jul8r2DwAAAAC/anime-boy.gif" , bio: "I am software enginner" );
...
#         ## expect(page).to have_no_content(Post.find(author: @user).first.title)
#     end
